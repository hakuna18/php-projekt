...
*/
    ...
    public function adminPanelAction(Request $request)
    {
        ...
        $reservations = $this->booksManager->getReservationRepository()->query($searchQuery, $reservationPage? $reservationPage : 1);

        $loansPage = $request->query->get('loansPage');
        $loans = $this->booksManager->getLoanRepository()->query($searchQuery, $loansPage? $loansPage : 1);
